...
- Single neuron == logistic regression without applying activation(perceptron)
...
- If we apply sigmoid activation function then Single neuron will act as Linear Regression.
